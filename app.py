...
@app.route("/admin/fardamento/termos/<int:termo_id>/excluir", methods=["POST"])
def excluir_termo_fardamento(termo_id):
    ...
    try:
        ...
        return jsonify({
            "sucesso": False,
            "mensagem": "Erro ao excluir o termo de entrega."
        }), 500
...
def controles_financeiros():
    ...
    try:
        ...
        # =====================================================
        #
        # Os grupos disponíveis no controle financeiro
        # vêm diretamente dos itens cadastrados em
        # itens_fardamento.
        #
        # Somente itens ativos são utilizados.
        #
        # No formulário será exibido SOMENTE o nome do item.
        #
        # Exemplo:
        #
        # Bota
        ...
        # Macacão
        #
        # O campo "tipo" é mantido na consulta apenas para
        # organização da lista no banco.
        #
        # =====================================================
        ...
        # =====================================================
        #
        # Nunca deixar temporadas fixas no HTML.
        #
        # A lista vem diretamente da tabela temporadas.
        #
        # =====================================================
...
def novo_controle_financeiro():
    ...
    try:
        ...
        if not temporada:
            ...
            return redirect(
                "/admin/financeiro/controles?erro=temporada"
            )


        # =================================================
        # VALIDAR TEMPORADA NO BANCO
        # =================================================
        ...
        # =================================================
        #
        # O grupo vem dos itens cadastrados em
        # itens_fardamento.
        #
        # O tipo NÃO vem mais do formulário.
        # Ele será identificado automaticamente
        ...
        if not grupo:
            ...
            return redirect(
                "/admin/financeiro/controles?erro=grupo"
            )


        # =================================================
        # BUSCAR ITEM DE FARDAMENTO
        # =================================================

        item_fardamento = db.execute(
            text("""
                SELECT
                    id,
                    nome,
        ...
        # =================================================
        #
        # O tipo é definido pelo cadastro de
        # itens_fardamento.
        #
        # Exemplo:
        #
        ...
        if not descricao:
            ...
            return redirect(
                "/admin/financeiro/controles?erro=descricao"
            )
        ...
        try:
            ...
            return redirect(
                "/admin/financeiro/controles?erro=quantidade"
            )
        ...
        try:
            ...
            return redirect(
                "/admin/financeiro/controles?erro=valor"
            )
        ...
        print(
            "ERRO AO CRIAR CONTROLE FINANCEIRO:",
            e
        )
    ...
    try:
        ...
        if request.method == "POST":
            ...
            if not grupo:
                ...
                return redirect(
                    f"/admin/financeiro/controles/{id}/editar?erro=grupo"
                )
            ...
            if not descricao:
                ...
                return redirect(
                    f"/admin/financeiro/controles/{id}/editar?erro=descricao"
                )
            ...
            try:
                ...
                return redirect(
                    f"/admin/financeiro/controles/{id}/editar?erro=quantidade"
                )
            ...
            try:
                ...
                return redirect(
                    f"/admin/financeiro/controles/{id}/editar?erro=valor"
                )
            ...
            if origem_pessoa == "INTEGRANTE":
                ...
                if not integrante_id:
                    ...
                    return redirect(
                        f"/admin/financeiro/controles/{id}/editar?erro=integrante"
                    )
            ...
            # =================================================
                ...
                if not nome_pessoa:
                    ...
                    return redirect(
                        f"/admin/financeiro/controles/{id}/editar?erro=nome"
                    )
        ...
        # =====================================================
        #
        # O campo GRUPO da edição é alimentado pelos
        # itens ativos cadastrados em itens_fardamento.
        #
        # Aqui usamos somente o nome.
        #
        # Exemplo:
        #
        # Camisa
        ...
        print(
            "ERRO AO EDITAR CONTROLE FINANCEIRO:",
            e
        )
        ...
        lista = db.execute(
            text("""
                SELECT
                    ...
                    COUNT(DISTINCT bc.id) AS total_cartelas,

                    COUNT(
                        DISTINCT CASE
                            WHEN bc.status = 'VENDIDA'
                            THEN bc.id
                        END
                    ) AS cartelas_vendidas
...
def bingo_novo():
    ...
    try:
        ...
        flash(
            "Ocorreu um erro ao criar o Bingo.",
            "danger"
        )
...
def bingo_editar(bingo_id):
    ...
    try:
        ...
        print(
            "ERRO AO ATUALIZAR BINGO:",
            e
        )

        flash(
            "Ocorreu um erro ao atualizar o Bingo.",
            "danger"
        )
...
@app.route("/admin/bingo/<int:bingo_id>")
def bingo_detalhes(bingo_id):
...
@app.route(
    "/admin/bingo/<int:bingo_id>/cartelas/gerar",
    methods=["POST"]
)
def bingo_gerar_cartelas(bingo_id):
    ...
    try:
        ...
        try:
            ...
            flash(
                "Informe uma quantidade válida de cartelas.",
                "danger"
            )
        ...
        if quantidade > 10000:
            ...
            flash(
                "A quantidade máxima para esta operação é de 10.000 cartelas.",
                "danger"
            )
        ...
        for i in range(quantidade):
            ...
            coluna_b = random.sample(
                range(1, 16),
                5
            )

            coluna_i = random.sample(
                range(16, 31),
                5
            )

            coluna_n = random.sample(
                range(31, 46),
                4
            )

            coluna_g = random.sample(
                range(46, 61),
                5
            )

            coluna_o = random.sample(
                range(61, 76),
                5
            )
        ...
        flash(
            f"{quantidade} nova(s) cartela(s) gerada(s) com sucesso!",
            "success"
        )
        ...
        print(
            "ERRO AO GERAR CARTELAS DO BINGO:",
            e
        )

        flash(
            "Ocorreu um erro ao gerar as cartelas.",
            "danger"
        )
...
@app.route(
    "/admin/bingo/<int:bingo_id>/cartelas/vender",
    methods=["POST"]
)
def bingo_registrar_venda(bingo_id):
    ...
    try:
        ...
        if not cartela_ids:
            ...
            flash(
                "Selecione pelo menos uma cartela para registrar a venda.",
                "warning"
            )
        ...
        try:
            ...
            flash(
                "Cartelas selecionadas inválidas.",
                "danger"
            )
        ...
        # =====================================================
        # BUSCAR CARTELAS DISPONÍVEIS
        # =====================================================

        cartelas_disponiveis = db.execute(
            text("""
                SELECT
                    id,
                    numero
        ...
        # =====================================================
        # VALIDAR SE TODAS ESTÃO DISPONÍVEIS
        # =====================================================

        if len(cartelas_disponiveis) != len(cartela_ids):

            db.rollback()

            flash(
                "Uma ou mais cartelas selecionadas já foram vendidas ou não pertencem a este Bingo.",
                "warning"
            )
        ...
        # =====================================================
        # CONFIRMAR QUANTIDADE ATUALIZADA
        # =====================================================

        if resultado.rowcount != quantidade_vendida:

            db.rollback()

            flash(
                "Não foi possível concluir a venda. As cartelas podem ter sido alteradas por outra operação.",
                "warning"
            )
        ...
        if tabela_vendas_existe:

            venda_resultado = db.execute(
                text("""
                    INSERT INTO bingo_vendas (
                        bingo_id,
                        quantidade_cartelas,
                        valor_unitario,
                        valor_total,
                ...
                {
                    "bingo_id": bingo_id,
                    "quantidade_cartelas": quantidade_vendida,
                    "valor_unitario": valor_unitario,
                    "valor_total": valor_total,
            ...
            tabela_itens_existe = db.execute(
                text("""
                    SELECT EXISTS (
                        ...
                        FROM information_schema.tables
                        WHERE table_schema = 'public'
                        AND table_name = 'bingo_venda_cartelas'
                    )
                """)
            ).scalar()
            ...
            if tabela_itens_existe:
                ...
                for cartela_id in cartela_ids:
                    ...
                    db.execute(
                        text("""
                            INSERT INTO bingo_venda_cartelas (
                                venda_id,
                                cartela_id
                            )
        ...
        print(
            "ERRO AO REGISTRAR VENDA DO BINGO:",
            e
        )

        flash(
            "Ocorreu um erro ao registrar a venda das cartelas.",
            "danger"
        )
...
@app.route(
    "/admin/bingo/<int:bingo_id>/prestacao-contas/pdf"
)
def bingo_prestacao_contas_pdf(bingo_id):
    ...
    try:
        ...
        print(
            "ERRO AO GERAR PRESTAÇÃO DE CONTAS DO BINGO:",
            e
        )

        flash(
            "Não foi possível gerar a prestação de contas.",
            "danger"
        )
